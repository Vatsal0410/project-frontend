...
import { AlertCircle, Calendar, Crown, FileText, Loader, Search, UserMinus, UserPlus, X } from "lucide-react";
...
const ProjectFormModal: FC<ProjectFormModalProps> = ({
  ...
  const fetchAllUsers = async () => {
    ...
    try {
      ...
      setAllUsers(users.filter(user => user.deleted_at === null && user.is_admin === false));
    } catch (err: any) {
...
<div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm animate-in fade-in duration-200" onClick={onClose}>
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl border border-gray-100 animate-in zoom-in-95 duration-200 max-h-[90vh] overflow-hidden" onClick={(e) => e.stopPropagation()}>
        {/* Header */}
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6 overflow-y-auto max-h-[calc(90vh-180px)]">
          ...
          <div className="space-y-4">
            <h3 className="text-sm font-medium text-gray-700 uppercase tracking-wide">Project Details</h3>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="space-y-1.5">
                ...
                {formErrors.end_date && (
                  <p className="text-xs text-red-600 mt-1">{formErrors.end_date}</p>
                )}
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <h3 className="text-sm font-medium text-gray-700 uppercase tracking-wide">Team Members</h3>
                    ...
                    <div key={user.id} className="flex items-center justify-between p-3 border border-gray-200 rounded-lg">
                      ...
                      <div className="flex items-center gap-2">
                        <button
                          ...
                          title={formData.leaderId === user.id ? "Project Leader" : "Set as Leader"}
                        >
                          <Crown size={16} />
                        </button>
                        <button
            ...
            <div className="space-y-3">
              ...
              {userLoading && (
                <div className="flex items-center justify-center py-4">
                  ...
                  <span className="text-sm text-gray-500 ml-2">Loading users...</span>
                </div>
              )}
          ...
          {formData.leaderId && (
            <div className="p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-medium text-yellow-800">Project Leader:</span>
                <span className="text-sm text-yellow-700">
                  {getLeader() ? `${getLeader()?.fname} ${getLeader()?.lname}` : "Selecting..."}
                </span>
              </div>
            </div>
          )}
